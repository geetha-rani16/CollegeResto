...
food1.addEventListener('click',()=>{
    food.style.backgroundImage="url('/pics/food1.png')";
});
food2.addEventListener('click',()=>{
    food.style.backgroundImage="url('/pics/food2.png')";
});
food3.addEventListener('click',()=>{
    food.style.backgroundImage="url('/pics/food3.png')";
});
food4.addEventListener('click',()=>{
    food.style.backgroundImage="url('/pics/food4.png')";
});